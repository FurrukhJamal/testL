            ...
            <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-8">
                ...
                <div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl ">
                    <div x-data = "{show : false}">
                        ...
                        {{--button--}}    
                        <div x-show = "show" style = "display : none;" class = "z-50 py-2 absolute bg-gray-100 w-full mt-2 rounded-xl">
                ...
                <?php /*<div class="relative flex lg:inline-flex items-center bg-gray-100 rounded-xl">
